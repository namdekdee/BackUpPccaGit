...
public class WorkOutObj {
	...
	private String approve_status_desc;
	private String approver;
	private String dtereq;
	
	
	public String getDtereq() {
		return dtereq;
	}
	public void setDtereq(String dtereq) {
		this.dtereq = dtereq;
	}
	...
	public String getApprove_status_desc() {
		return approve_status_desc;
	}
	public void setApprove_status_desc(String approve_status_desc) {
		this.approve_status_desc = approve_status_desc;
	}
