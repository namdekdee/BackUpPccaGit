               ...
               <h4 class="modal-title">ตั้งค่าการบันทึกคำร้อง</h4>
	             ...
	             <form class="form-horizontal" id="frmHrisSetupReqt">
		             ...
		             <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                   	<input type="text"  class="form-control" id="prevDay" name = "prevDay" >
		                  </div>
	                 </div>		                    
		             <div class="form-group">
		             ...
		             <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                  	<select id="reqtStart" name="reqtStart" class="form-control select2" style="width: 100%;">
		                    	<option value="">เลือก</option>
		                    </select>
		                  </div>
		                  ...
		                  <div class="col-sm-4">
			                   <select id="reqtEnd" name="reqtEnd" class="form-control select2" style="width: 100%;">
			                    	<option value="">เลือก</option>
			                    </select>
		                  </div>
	                 </div>	
