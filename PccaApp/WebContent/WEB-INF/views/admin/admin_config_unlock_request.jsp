...
<div style="background-color: white;" class="testscoll">
			...
			<div class="box collapsed-box">
				<div class="box-header">					
					...
					<div class="box-tools pull-right">
						<span  class="btn btn-box-tool" data-widget="collapse"><img src="resources/Images/dot.png" style="width:20px;height:20px;">
						</span>
					</div>
				</div>
				<div class="box-body">				 
				 	<button type="button" class="btn btn-primary pull-right" id="btnDelete" onclick="deleteReq()">ลบ</button>
      				<button type="button" class="btn btn-primary pull-right" id="btnAdd" style="margin-right: 10px" onclick="modalreq('00')">เพิ่ม</button>
				 </div>				
			</div>
		</div>
	</div>	
	...
	<div class="box-footer" id="divButton2">
       <button type="button" class="btn btn-primary pull-right" id="btnDelete" 	onclick="deleteReq()" >ลบ</button>
       <button type="button" class="btn btn-primary pull-right" id="btnAdd" onclick="modalreq('00')" style="margin-right: 10px">เพิ่ม</button>
     </div>
	             ...
	             <form class="form-horizontal" id="frmHrisSetupReqt">
		             ...
		             <div class="form-group">		             
		                  ...
		                  <div class="col-sm-5">
				                ...
				                <select id="codeEmp" name="codeEmp" class="form-control select2" onchange="searchEmp()" style="width: 100%;">
		             ...
		             <div class="form-group">
		             	  <span class="col-sm-1 text-left"></span>	
		                  <span id="lblpname" class="col-sm-5 text-left"></span>		                  
		                  <span id="lblnampost" class="col-sm-5 text-left"></span>		                  
	                 </div>
	                 <div class="form-group">
	                 	  <span  class="col-sm-1 text-left"></span>	
		                  <span id="lblsection" class="col-sm-5 text-left"></span>		                  
		                  <span id="lblpart" class="col-sm-5 text-left"></span>		                  
	                 </div>			                    
		             <div class="form-group">
		             	 <hr/>
		             </div>
		             <div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                  	<select id="menuId" name="menuId" class="form-control" style="width: 100%;">
		                    	<option value="">เลือก</option>
		                    </select>
		                  </div>
		                  ...
		                  <div class="col-sm-4">
			                   <select id="action" name="action" class="form-control " style="width: 100%;">
			                    	<option value="">เลือก</option>
			                    </select>
		                  </div>
	                 </div>	
