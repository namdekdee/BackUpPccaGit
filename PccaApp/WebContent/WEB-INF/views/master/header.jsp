...
<header class="main-header"> <!-- Logo --> <a href="#"
			...
			class="logo-mini">PCCA</span>
			<!--class="logo-mini"><b>H</b>IS</span> //logo for regular state and mobile devices -->
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu" ><a
					...
					<!-- span class="hidden-xs" id="lblUserRight"></span>&nbsp;<i class="fa fa-gears"></i -->
					<i class="glyphicon glyphicon-user"></i>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header" style="height:Auto" ><img id="imgUserRightDown"
							src="resources/Images/logo.png" class="img-circle"
							alt="User Image">
							<p id="lblEmpIDMain"></p>
							<p id="lblNameMain">
								<!-- span id="lblNamePosition">split a name and a position away</span -->
							</p>
							<p id="lblPositionMain"></p>
						</li>
						<!-- Menu Body -->
						<li class="user-body">
							<div class="row">
								<!-- div class="pull-left" -->
								<div align="center">
									<a href="member-profile" class="btn btn-default btn-flat"> <span
										id="lblProfile"></span>
									</a>
								</div>
