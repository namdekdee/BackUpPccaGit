 ...
 <script src="<%=request.getContextPath()%>/resources/plugins/html5shiv/html5shiv.min.js"></script>
  ...
  <style type="text/css">
	...
	<script src="<%=request.getContextPath()%>/resources/plugins/jQuery/jquery-2.2.3.min.js"></script>
   	<script src="<%=request.getContextPath()%>/resources/Scripts/MasterRoot.js"></script>
    <script type='text/javascript'>
        ...
        function Login() {     
	       	try{
		       	...
		       	setTimeout(function () { waitingDialog.hide(); }, 50000);
	           	var data = {}
...
<body style="background-color: white;overflow-y:hidden;">
 <div style="overflow:hidden;" class="div-login">
      ...
      <table style="height:100%;width: 100%;">     
         ...
         <div class="login-box" >
 <div id="divValid" class="alert alert-danger alert-dismissible" hidden="hidden">
            <button type="button" class="close" data-hide="alert">&times;</button>
            <h4><i class="icon fa fa-info"></i>Error!</h4>
            CRA-00001: user name or password not found.
             
        </div>
        <div id="divTran" class="alert alert-danger alert-dismissible" hidden="hidden">
            <button type="button" class="close" data-hide="alert">&times;</button>
            <h4><i class="icon fa fa-info"></i>Error!</h4>
